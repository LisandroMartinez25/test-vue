<template>
  <header class="sm:flex sm:justify-between sm:items-center sm:px-4 sm:py-3 md:px-16">
    ...
    <nav :class="isOpen ? 'block' : 'hidden'" class="px-2 pt-2 pb-4 sm:flex sm:p-0">
      <a href="#" class="block px-2 py-1 font-semibold rounded ">Cundinamarca</a>
      <a href="#" class="mt-1 block px-2 py-1 font-semibold rounded sm:mt-0 sm:ml-2">Antioquia</a>
      <a href="#" class="mt-1 block px-2 py-1 font-semibold rounded sm:mt-0 sm:ml-2">Recursos</a>
      <account-menu />
    </nav>
  </header>
</template>
